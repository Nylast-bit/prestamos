...
exports.exportAll = exports.importBatch = void 0;
const asyncHandler_1 = require("../middlewares/asyncHandler");
const importService = __importStar(require("../services/import.service"));
const supabaseClient_1 = require("../config/supabaseClient");
exports.importBatch = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const { rows } = req.body;
...
exports.exportAll = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const idEmpresa = req.user.IdEmpresa;
    const { data: prestamos, error } = await supabaseClient_1.supabase
        .from("Prestamo")
        .select(`
      *,
