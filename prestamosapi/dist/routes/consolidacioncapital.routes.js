...
router.get("/:id/auditorias", consolidacioncapital_controller_1.getHistorialAuditoria);
router.post("/:id/auditar", consolidacioncapital_controller_1.auditarConsolidacion);
