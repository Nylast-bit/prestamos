...
const getConsolidacionDates = async (id: number, idEmpresa: number) => {
...
const getActiveFixedExpenses = async (idConsolidacion: number, idEmpresa: number) => {
 ...
 */
export const processFixedExpenses = async (idConsolidacion: number, idEmpresa: number) => {
