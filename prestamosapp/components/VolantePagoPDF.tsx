    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ 
          ...
          <div>
            <h1 style={{ fontSize: '32px', fontWeight: 900, color: '#213685', margin: 0 }}>
              CREDIT WAY
            </h1>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: '40px', marginBottom: '48px' }}>
          <div style={{ flex: 1 }}>
            <div style={{ borderTop: '2px solid #1e293b', paddingTop: '8px', marginTop: '60px' }}>
              <p style={{ fontSize: '12px', fontWeight: 600, color: '#1e293b', margin: 0, textAlign: 'center' }}>Firma Autorizada</p>
              <p style={{ fontSize: '10px', color: '#64748b', margin: '4px 0 0 0', textAlign: 'center' }}>Credit Way S.R.L</p>
            </div>
          </div>
          <div style={{ flex: 1 }}>
            <div style={{ borderTop: '2px solid #1e293b', paddingTop: '8px', marginTop: '60px' }}>
