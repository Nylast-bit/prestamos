  ...
  const actions = [
    {
      ...
      iconStyle: "bg-blue-100 text-blue-600 dark:bg-blue-950 dark:text-blue-400 group-hover:bg-blue-600 text-white dark:text-white group-hover:text-white dark:group-hover:bg-blue-500",
    ...
    },
    {
      ...
      iconStyle: "bg-emerald-100 text-emerald-600 dark:bg-emerald-950 dark:text-emerald-400 group-hover:bg-emerald-600 text-white dark:text-white group-hover:text-white dark:group-hover:bg-emerald-500",
    ...
    },
    {
      ...
      iconStyle: "bg-amber-100 text-amber-600 dark:bg-amber-950 dark:text-amber-400 group-hover:bg-amber-600 text-white dark:text-white group-hover:text-white dark:group-hover:bg-amber-500",
